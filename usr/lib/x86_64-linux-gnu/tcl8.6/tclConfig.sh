...
TCL_EXTRA_CFLAGS='-g -O2 -fdebug-prefix-map=/build/tcl8.6-AHNbz5/tcl8.6-8.6.10+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security -fno-unit-at-a-time -pipe -Wdate-time -D_FORTIFY_SOURCE=2'
