...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/usr' '--enable-multiarch' '--target=x86_64-linux-gnu' '--program-suffix=2.7' '--with-soname=ruby-2.7' '--enable-shared' '--disable-rpath' '--with-sitedir=/usr/local/lib/site_ruby' '--with-sitearchdir=/usr/local/lib/x86_64-linux-gnu/site_ruby' '--runstatedir=/var/run' '--localstatedir=/var' '--sysconfdir=/etc' 'AS=x86_64-linux-gnu-as' 'CC=x86_64-linux-gnu-gcc' 'CXX=x86_64-linux-gnu-g++' 'LD=x86_64-linux-gnu-ld' '--enable-ipv6' '--with-dbm-type=gdbm_compat' '--with-compress-debug-sections=no' 'CFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong -Wformat -Werror=format-security' 'CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2' 'CXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong -Wformat -Werror=format-security' 'FCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong' 'FFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong' 'GCJFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong' 'LDFLAGS=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now' 'OBJCFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong -Wformat -Werror=format-security' 'OBJCXXFLAGS=-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong -Wformat -Werror=format-security' 'target_alias=x86_64-linux-gnu'"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "x86_64-linux-gnu-gcc (Ubuntu 9.3.0-17ubuntu1~20.04) 9.3.0\nCopyright (C) 2019 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CXXFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong -Wformat -Werror=format-security"
  ...
  CONFIG["CFLAGS"] = "-g -O2 -fdebug-prefix-map=/build/ruby2.7-ZqA6X9/ruby2.7-2.7.5=. -fstack-protector-strong -Wformat -Werror=format-security -fPIC"
